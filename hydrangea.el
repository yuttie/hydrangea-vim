     ...
     (define-minor-mode ,(intern (concat (symbol-name theme) "-theme-adjustment-mode"))
       ...
       :keymap (let ((map (make-sparse-keymap)))
                 ...
                 (define-key map (kbd "<f6>")  (lambda ()
                                                 ...
                                                 (load-theme ',theme)))
                 (define-key map (kbd "<f7>")  (lambda () (interactive) (setq ,(intern (concat (symbol-name theme) "-theme-tune-hue"))        (- ,(intern (concat (symbol-name theme) "-theme-tune-hue"))        5)) (load-theme ',theme)))
                 (define-key map (kbd "<f8>")  (lambda () (interactive) (setq ,(intern (concat (symbol-name theme) "-theme-tune-hue"))        (+ ,(intern (concat (symbol-name theme) "-theme-tune-hue"))        5)) (load-theme ',theme)))
                 ...
                 (define-key map (kbd "<f11>") (lambda () (interactive) (setq ,(intern (concat (symbol-name theme) "-theme-tune-lightness"))  (- ,(intern (concat (symbol-name theme) "-theme-tune-lightness"))  5)) (load-theme ',theme)))
                 (define-key map (kbd "<f12>") (lambda () (interactive) (setq ,(intern (concat (symbol-name theme) "-theme-tune-lightness"))  (+ ,(intern (concat (symbol-name theme) "-theme-tune-lightness"))  5)) (load-theme ',theme)))
                 map)
