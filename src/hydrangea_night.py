...
color['Pmenu']        = dict(fg=p['gray'][+4],    bg=p['gray'][-3],    deco='NONE')
color['PmenuSel']     = dict(fg='NONE',           bg=p['gray'][-2],    deco='bold')
color['PmenuSbar']    = dict(                     bg=p['gray'][-3],    deco='NONE')
