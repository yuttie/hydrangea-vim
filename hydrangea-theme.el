...
(eval-when-compile
  ...
  (defmacro hydrangea-theme-palette ()
    ...
    '((base03        "#1c1f26"   "#121212")
      (base02        "#2b303b"   "#262626")
      (base01        "#333946"   "#3a3a3a")
      (base00        "#3c4453"   "#4e4e4e")
      (base0         "#565f72"   "#6c6c6c")
      (base1         "#626c82"   "#878787")
      (base2         "#c1d0e3"   "#b2b2b2")
      (base3         "#dfedff"   "#eeeeee")
      (red           "#e91e63"   "#af5f5f")
      (aqua          "#36c399"   "#87afaf")
      (aqua-dark     "#114335"   "#87afaf")
      (cyan          "#1cc7de"   "#87afaf")
      (blue          "#6d88ff"   "#6985ff")
      (blue-dark     "#243166"   "#6985ff")
      (violet        "#b490ff"   "#8787af")
      (magenta       "#e242ac"   "#af87af")
      (magenta-light "#e481ce"   "#af87af")
      (emacs         "#5955a9"   "#5955a9")
      (diff-add-fg   "#00bbff"   "#005f00")
      (diff-add-bg   "#0d4a60"   "#005f00")
      (diff-add-hi   "#97e3ff"   "#005f00")
      (diff-rm-fg    "#e246ae"   "#5f0000")
      (diff-rm-bg    "#66184c"   "#5f0000")
      (diff-rm-hi    "#fface3"   "#005f00")))
