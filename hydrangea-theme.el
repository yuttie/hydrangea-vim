...
(eval-when-compile
  ...
  (defmacro hydrangea-theme-face-definitions ()
    '(;; Standard
      ...
      (powerline-mode-visual   :foreground base02             :background yellow :box nil)
      (powerline-mode-replace  :foreground base02             :background red    :box nil)
      (powerline-mode-operator :foreground base02             :background red    :box nil)
      (powerline-mode-emacs    :foreground (lighten 40 emacs) :background emacs  :box nil)
