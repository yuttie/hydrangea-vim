...
(eval-when-compile
  ...
  (defmacro hydrangea-theme-palette ()
    ...
    '((base03   "#1f2226"   "#262626")
      (base02   "#272b30"   "#303030")
      (base01   "#4d5259"   "#4e4e4e")
      (base00   "#5c626a"   "#626262")
      (base0    "#6e747d"   "#767676")
      (base1    "#838a94"   "#8a8a8a")
      (base2    "#cbd4e0"   "#d0d0d0")
      (base3    "#edf5ff"   "#eeeeee")
  ...
  (defmacro hydrangea-theme-face-definitions ()
    '(;; Standard
      ...
      (mode-line          :inherit (variable-pitch) :background base01 :foreground base2 :box nil)
      (mode-line-inactive :inherit (variable-pitch) :background base02 :foreground base0 :box nil)
      (minibuffer-prompt  :foreground base3)
      (window-divider     :foreground (darken 4 base03))
      ...
      (powerline-first-normal       :background base00            :foreground (lighten 50 base01))
      (powerline-first-insert       :background "#87d7ff"         :foreground "#005f87")
      (powerline-first-inactive     :background (darken 5 base00) :foreground (lighten 20 base01))
      (powerline-second-normal      :background base01            :foreground (lighten 50 base01))
      (powerline-second-insert      :background "#0087af"         :foreground "#87d7ff")
      (powerline-second-inactive    :background (darken 5 base01) :foreground (lighten 20 base01))
      (powerline-third-normal       :background base02            :foreground (lighten 50 base02))
      (powerline-third-insert       :background "#005f87"         :foreground "#87d7ff")
      (powerline-third-inactive     :background (darken 5 base02) :foreground (lighten 20 base02))
      ...
      ;; Highlight
      (highlight           :background base01 :foreground base3)
      (isearch             :background (darken 5 yellow) :foreground base03 :box (:line-width -1 :color (lighten 5 yellow) :style nil))
      (query-replace       :inherit (isearch))
      (lazy-highlight      :background nil :inherit (isearch))
      (region              :background base01 :foreground unspecified)
      (secondary-selection :background base02)
      (trailing-whitespace :background red)
      (escape-glyph        :foreground yellow)
      ;; whitespace
      (whitespace-line :background yellow :foreground base03)
      ;; Main
      ...
      ;; show-paren-mode
      (show-paren-match :background blue :foreground base03 :weight bold)
      ;; auto-complete
      ...
      ;; avy
      (avy-lead-face   :foreground base03 :background green)
      (avy-lead-face-0 :foreground base03 :background green)
      (avy-lead-face-2 :foreground base03 :background green)
      ;; ace-window
      (aw-leading-char-face :inherit (default) :foreground green :height 4.0)
      (aw-background-face   :inherit (default) :foreground base03)
      ;; company-mode
      (company-tooltip                  :inherit (default) :background base02)
      (company-tooltip-selection        :inherit (company-tooltip) :background base01 :foreground base3 :weight bold)
      ...
      (company-preview                  :foreground base3 )
      ...
      (diff-removed        :background diff-rm  :foreground base3)
      (diff-added          :background diff-add :foreground base3)
      (diff-changed        )
      (diff-function       :foreground red :background base03 :inherit (diff-header))
      ...
      (helm-header           :background violet      :foreground base03 :height 1.414)
      ...
      ;; ElScreen
      (elscreen-tab-background-face     :inherit (variable-pitch) :background base02 :foreground base2 :underline nil :height 1.4 :box (:line-width 8 :color base02))
      ...
      (elscreen-tab-other-screen-face   :inherit (elscreen-tab-background-face) :foreground base00 :height 1.0)
      ;; Shell
      (comint-highlight-prompt :foreground blue  :weight bold)
      (comint-highlight-input  :foreground base3 :weight bold)
      ;; DDSKK
      (skk-henkan-face :inherit (default) :foreground base3)
      (skk-jisyo-registration-badge-face :background yellow :foreground base3)
      (skk-inline-show-face :inherit (default))
      (skk-verbose-intention-face :inherit (shadow))
      (skk-dcomp-face :foreground base3)
      (skk-dcomp-multiple-face  :background base02 :foreground green)
...
(hydrangea-define-theme hydrangea
  ...
  (setq skk-inline-show-background-color (nth 1 (assq 'base02 palette)))
  (setq skk-inline-show-background-color-odd (color-lighten-name (nth 1 (assq 'base02 palette)) 5)))
