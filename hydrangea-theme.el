...
(eval-when-compile
  ...
  (defmacro hydrangea-theme-face-definitions ()
    '(;; Standard
      ...
      ;; powerline
      (powerline-mode-normal   :foreground base02 :background green  :box nil :weight bold )
      ...
      (powerline-mode-insert   :foreground blue2 :background base2 :box nil :weight bold )
      (powerline-first-insert  :foreground blue2 :background blue0                       )
      (powerline-second-insert :foreground base2 :background blue1                       )
      (powerline-third-insert  :foreground blue0 :background blue2                       )
      (powerline-buffer-id-insert :inherit (powerline-second-insert))

      (powerline-mode-visual   :foreground base02             :background yellow :box nil :weight bold)
      (powerline-mode-replace  :foreground base02             :background red    :box nil :weight bold)
      (powerline-mode-operator :foreground base02             :background red    :box nil :weight bold)
      (powerline-mode-emacs    :foreground (lighten 40 emacs) :background emacs  :box nil :weight bold)

      (powerline-mode-inactive   :foreground base01 :background base0 :box nil)
      (powerline-first-inactive  :foreground base01 :background base0         )
      (powerline-second-inactive :foreground base1  :background base00        )
      (powerline-third-inactive  :foreground base0  :background base01        )
