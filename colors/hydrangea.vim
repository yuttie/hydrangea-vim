...
hi VertSplit ctermfg=133 ctermbg=53 cterm=NONE guifg=#2c4d70 guibg=#090c19 gui=NONE
hi WinSeparator ctermfg=133 ctermbg=53 cterm=NONE guifg=#2c4d70 guibg=#090c19 gui=NONE
hi LineNr ctermfg=133 ctermbg=133 cterm=NONE guifg=#353843 guibg=#131621 gui=NONE
hi CursorLineNr ctermfg=225 ctermbg=133 cterm=bold guifg=#5a5d6a guibg=#353843 gui=bold
...
hi MatchParen ctermfg=133 ctermbg=NONE cterm=bold guifg=#ac2437 guibg=NONE gui=bold
...
hi Ignore guifg=bg
hi Error ctermfg=133 ctermbg=133 cterm=bold guifg=#ac2437 guibg=#7c0016 gui=bold
hi Todo ctermfg=225 ctermbg=133 cterm=bold guifg=#6a763d guibg=#202b00 gui=bold
hi IncSearch ctermfg=225 ctermbg=225 cterm=bold guifg=#d59ecd guibg=#7e4c78 gui=bold
hi Search ctermfg=225 ctermbg=133 cterm=bold guifg=#d59ecd guibg=#562650 gui=bold
...
hi ErrorMsg ctermfg=133 ctermbg=NONE cterm=NONE guifg=#ac2437 guibg=NONE gui=NONE
...
hi WarningMsg ctermfg=133 cterm=NONE guifg=#ac2437 gui=NONE
hi WildMenu ctermfg=225 ctermbg=133 cterm=bold guifg=#5a5d6a guibg=#353843 gui=bold
hi ColorColumn ctermfg=NONE ctermbg=133 cterm=NONE guifg=NONE guibg=#7c0016 gui=NONE
hi @variable.parameter ctermfg=225 guifg=#7e8a51
hi @variable.parameter.builtin ctermfg=225 guifg=#7e8a51
hi DiagnosticError ctermfg=133 ctermbg=133 cterm=NONE guifg=#ac2437 guibg=#7c0016 gui=NONE
hi DiagnosticWarn ctermfg=225 ctermbg=133 cterm=NONE guifg=#6e4aa7 guibg=#44247c gui=NONE
hi DiagnosticInfo ctermfg=225 ctermbg=133 cterm=NONE guifg=#55739a guibg=#2c4d70 gui=NONE
hi DiagnosticHint ctermfg=225 ctermbg=133 cterm=NONE guifg=#6a763d guibg=#424f19 gui=NONE
...
hi CmpItemAbbrMatch ctermfg=225 guifg=#6a763d
hi CmpItemAbbrMatchFuzzy ctermfg=133 guifg=#ac2437
...
hi rainbowcol2 ctermfg=225 guifg=#6a763d
