...
(let* (;; Palette
       (base4   "#202026") (base4-256   "#1c1c1c")
       (base3   "#303038") (base3-256   "#303030")
       (base2   "#40404a") (base2-256   "#444444")
       (base1   "#50505b") (base1-256   "#4e4e4e")
       (base0   "#80808d") (base0-256   "#808080")
       (base-1  "#d0d0de") (base-1-256  "#d0d0d0")
       (base-2  "#f0f0ff") (base-2-256  "#eeeeee")
       (red     "#e38484") (red-256     "#d78787")
       (orange  "#dda277") (orange-256  "#dfaf87")
       (yellow  "#e7d56d") (yellow-256  "#dfdf5f")
       (green   "#bdd16e") (green-256   "#afd75f")
       (cyan    "#8fd7cf") (cyan-256    "#87d7d7")
       (blue    "#7dc0df") (blue-256    "#87d7ff")
       (violet  "#a891e7") (violet-256  "#af87ff")
       (magenta "#d78cc7") (magenta-256 "#d787d7")
       (red     (color-lighten-name (color-saturate-name red     night-theme-tune-saturation) night-theme-tune-lightness))
       (orange  (color-lighten-name (color-saturate-name orange  night-theme-tune-saturation) night-theme-tune-lightness))
       (yellow  (color-lighten-name (color-saturate-name yellow  night-theme-tune-saturation) night-theme-tune-lightness))
       (green   (color-lighten-name (color-saturate-name green   night-theme-tune-saturation) night-theme-tune-lightness))
       (cyan    (color-lighten-name (color-saturate-name cyan    night-theme-tune-saturation) night-theme-tune-lightness))
       (blue    (color-lighten-name (color-saturate-name blue    night-theme-tune-saturation) night-theme-tune-lightness))
       (violet  (color-lighten-name (color-saturate-name violet  night-theme-tune-saturation) night-theme-tune-lightness))
       (magenta (color-lighten-name (color-saturate-name magenta night-theme-tune-saturation) night-theme-tune-lightness))
