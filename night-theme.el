...
(let (;; Palette
      ...
      (red     "#f0a3a3") (red-256     "#d75f5f")
      (orange  "#f7b788") (orange-256  "#d75f5f")
      (yellow  "#ffeb81") (yellow-256  "#dfaf00")
      (green   "#d8f572") (green-256   "#87af00")
      (cyan    "#9ff7ed") (cyan-256    "#00afaf")
      (blue    "#85d7fc") (blue-256    "#0087ff")
      (violet  "#c6b4f8") (violet-256  "#875fff")
      (magenta "#f3c0e8") (magenta-256 "#d75faf")
